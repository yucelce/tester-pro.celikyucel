...
export const ITEM_DESCRIPTIONS: Record<string, string> = {
  ...
  "Yağmur Suyu Hasat Sistemi": "Çevre ve Şehircilik Bakanlığı kararınca, belirli bir büyüklüğün (örn: 2000 m²) üzerindeki parsellerde, çatılardan gelen yağmur suyunu toplayıp filtreleyerek bahçe sulamada veya rezervuarlarda kullanmak üzere yeraltı tankında depolayan ekolojik ve zorunlu bir sistemdir.",
