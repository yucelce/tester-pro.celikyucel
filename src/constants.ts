...
export const DEFAULT_PRICES: Record<string, number> = {
    ...
    "Kırıcı İş Makinesi Farkı (Kayalık)": 4872,
    "Püskürtme Beton (İksa)": 610,
    "Kule Vinç Aylık Kira ve Operatör": 230000,
    "Kule Vinç Kurulum ve Söküm Bedeli": 230000,
    "Şantiye Araç Giderleri (Aylık)": 35780,
    "Mobil Vinç Hizmet Bedeli": 16615,
    "Kuyu Temel Kazı İşçiliği": 3937.5,
    "Kuyu Temel Kalıp ve Donatı İşçiliği": 2362.5,
    "İç Sıva (Kara Sıva)": 605,
    "Alçı Sıva (Kaba+Saten)": 595,
    "İç Cephe Boyası": 238.9,
    "Tavan Boyası": 162.3,
    "Asma Tavan (Alçıpan)": 1101.3,
    "Kartonpiyer / Stropiyer": 149.1,
    "Duvar Örme Harcı (Kara Harç)": 2300,
    "Mantolama Malzemesi": 358,
    "Mantolama İşçiliği": 885.9,
    "Otopark Tavanı Yangın/Isı Yalıtımı (Taşyünü)": 1243.9,
    "Şap Malzemesi": 107.84,
    "Şap İşçiliği": 283.5,
    "PVC Pencere (Doğrama)": 5110,
    "Mermer Denizlik": 1188.2,
    "Balkon Korkulukları (Alüminyum)": 2045,
    "İskele Kirası (Aylık)": 66,
    "İskele Kurulum/Söküm": 141.8,
    ...
    "İç Merdiven Korkuluk": 2894.3,
    "Süpürgelik": 330.2,
    "Sahanlık ve Kat Holü Mermer": 3052.5,
    "Mermer Harcı ve Kumu": 2300,
    "Çelik Kapı (Daire Giriş)": 26580,
    "İç Kapı (Panel/Lake)": 4860,
    "Mutfak Dolabı (Standart)": 6900,
    "Mutfak Tezgahı (Granit/Çimstone)": 6900,
    "Banyo Dolabı & Lavabo": 6130,
    "Klozet Takımı (Gömme Rezervuar)": 6750,
    "Duşakabin": 10220,
    "Bina Giriş Kapısı (Ana)": 61304.36,
    "Portmanto / Vestiyer": 17125,
    "Davlumbaz / Aspiratör": 4855,
    "Lavabo Bataryası": 1585,
    "Evye Bataryası": 3580,
    "Mutfak Evyesi": 4345,
    "Duş Seti (Başlık/Hortum)": 2556,
    "Kombi ve Baca Montajı": 32204.69,
    ...
    "Modüler Su Deposu (2m3 Paket)": 9713,
    "Hidrofor Sistemi": 7157,
    "Klima Altyapısı (Bakır Borulama)": 30700,
    "İş Makinesi (JCB/Ekskavatör)": 3480,
    "Banyo ve Islak Hacim Su Yalıtımı": 480,
    "Balkon ve Teras Su Yalıtımı": 480,
    "Çatı Konstrüksiyon ve Kaplama": 2515,
    "Subasman Dolgusu (Stabilize/Mıcır)": 655,
    "Temel Yalıtım Koruma (XPS)": 205,
    "Isı Pompası (Hava Kaynaklı Dış Ünite)": 206200,
    "VRF Dış Ünite (Merkezi Sistem)": 318600,
    "VRF İç Ünite (Kaset/Duvar Tipi)": 31860,
    "VRF Bakır Borulama ve Altyapı": 1200,
    "Havuz Mekanik Tesisatı (Motor, Filtre, Aydınlatma)": 168700,
    "Doğalgaz Proje ve Onay Bedeli": 12886.4,
    "Sıhhi Tesisat (Temiz+Pis Su)": 23625,
    "Kamera ve Güvenlik Altyapısı": 23000,
    "Anahtar/Priz Montajı ve Malzemesi": 165,
    "Daire Sigorta Panosu ve Şalt Malz.": 6390,
    "Temel Topraklaması (Galvaniz Şerit)": 51.2,
    "Görüntülü Diafon Sistemi": 6415,
    "Merkezi Uydu Sistemi": 26070,
    "Cephe Aydınlatma (Wallwasher)": 1280,
    "Şantiye Elektrik Panosu (Geçici)": 12780,
