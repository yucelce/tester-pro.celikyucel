...
export const ProjectProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (result.status === 'success' && Array.isArray(result.data)) {
                        ...
                        // DÖNGÜ BİTTİKTEN SONRA DEĞERLERİ ALIP TEK SEFERDE STATE'E YAZIYORUZ
    ...
    const { projectCostDetails, projectTotalCost, globalStructuralCost, interiorFitoutCost, globalStats } = useMemo(() => {
        ...
        // ÖNCE LİSTEYİ BELİRLE: Kullanıcı çizim yapmadıysa ve oto moddaysa SANAL KATLARI oluştur
        ...
        // SONRA HESAPLA: Sadece TEK BİR DÖNGÜ (forEach) ile listeyi işle
        ...
        if (nonResidentialArea > 0) {
            ...
            if (parkingArea > 0) {
                ...
                addBreakdown(`wall_${innerThickStr}_area`, 'Otopark İç Duvar (Açık Alan) Düzeltmesi', -generatedInnerWalls);
            }
            ...
            if (shelterArea > 0) {
                ...
                aggregatedUnitStats[`wall_${innerThickStr}_area`] = Math.max(0, (aggregatedUnitStats[`wall_${innerThickStr}_area`] || 0) - generatedInnerWalls);
                addBreakdown(`wall_${innerThickStr}_area`, 'Sığınak İç Duvar Düzeltmesi', -generatedInnerWalls);
            }
