...
import { generateSystemWarnings } from '../utils/regulationChecks';
...
export const ProjectProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    useEffect(() => {
        const warnings = generateSystemWarnings({
            areaValidation,
            buildingStats,
    ...
    }, [areaValidation, buildingStats, totalConstructionArea, projectCostDetails, units]);
    ...
    const triggerBackendCalculation = useCallback(async () => {
        ...
        try {
            ...
            const payload = {
                ...
                customCosts,
                duplexPairs,
                costs: optimizedCosts, // Artık sadece hafif paket gidiyor
                totalConstructionArea,
