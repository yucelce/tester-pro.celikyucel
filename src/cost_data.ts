...
export const COST_DATA: CostCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mevcut Bina Yıkım Ruhsat Bedeli", unit: "Paket", unit_price: 350, auto_source: "calc_demolition_area", multiplier: 1, scope: 'global', inputType: 'manual_total' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Şantiye Elektrik Tüketimi (Aylık)", unit: "Ay", unit_price: 2.5, auto_source: "calc_duration_months", multiplier: 1, scope: 'global' },
  ...
  },
  {
    ...
    items: [
      { name: "Kuyu Temel Betonu", unit: "m3", unit_price: 3890, auto_source: "calc_well_foundation_concrete", multiplier: 1, scope: 'global' },
      { name: "Kuyu Temel Demiri", unit: "ton", unit_price: 30600, auto_source: "calc_well_foundation_iron", multiplier: 1, scope: 'global' },
      { name: "Kuyu Temel Kalıp ve Donatı İşçiliği", unit: "m2", unit_price: 1800, auto_source: "calc_well_foundation_formwork", multiplier: 1, scope: 'global' },
      { name: "Betonarme Betonu", unit: "m3", unit_price: 3890, auto_source: "calc_concrete_global", multiplier: 1, scope: 'global' },
      { name: "Grobeton", unit: "m3", unit_price: 3300, auto_source: "calc_grobeton", multiplier: 1, scope: 'global' },
      { name: "İnşaat Demiri", unit: "ton", unit_price: 30600, auto_source: "calc_iron_global", multiplier: 1, scope: 'global' },
      { name: "Kalıp İşçiliği & Malzeme", unit: "m2", unit_price: 1347, auto_source: "calc_formwork_global", multiplier: 1, scope: 'global' },
      { name: "Temel Su Yalıtımı (Bohçalama)", unit: "m2", unit_price: 450, auto_source: "calc_foundation_area", multiplier: 1.1, scope: 'global' },
      { name: "Temel Yalıtım Koruma (XPS)", unit: "m2", unit_price: 150, auto_source: "calc_foundation_xps", multiplier: 1.05, scope: 'global' },
      ...
      { name: "Yangın Merdiveni (Çelik)", unit: "Kat", unit_price: 1, auto_source: "calc_fire_escape", multiplier: 1, scope: 'global', inputType: 'manual_total' }
    ]
  },
  {
    id: "duvar_tavan",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sahanlık ve Kat Holü Mermer", unit: "m2", unit_price: 1500, auto_source: "calc_hall_area", multiplier: 1, scope: 'global' },
      { name: "Merdiven Mermer Kaplama", unit: "Basamak", unit_price: 1500, auto_source: "calc_stairs", multiplier: 1, scope: 'global' },
      { name: "Merdiven Korkuluğu", unit: "mt", unit_price: 1800, auto_source: "calc_stairs_railing", multiplier: 1, scope: 'global' },
  ...
  },
  {
    ...
    items: [
      { name: "Bina Giriş Kapısı (Ana)", unit: "Adet", unit_price: 60876, auto_source: "manual", multiplier: 1, scope: 'global', inputType: 'manual_total' },
      { name: "Çelik Kapı (Daire Giriş)", unit: "Adet", unit_price: 26910, auto_source: "calc_steel_door", multiplier: 1, scope: 'unit' },
      { name: "İç Kapı (Panel/Lake)", unit: "Adet", unit_price: 4920, auto_source: "calc_inner_door", multiplier: 1, scope: 'unit' },
      { name: "Yangın Kapısı (Adet)", unit: "Adet", unit_price: 18000, auto_source: "manual", multiplier: 0, scope: 'hidden' },
      { name: "Mutfak Dolabı (Standart)", unit: "m2", unit_price: 6985, auto_source: "calc_kitchen_cabinet", multiplier: 1, scope: 'unit' },
      ...
      { name: "İç Merdiven Kaplama", unit: "Basamak", unit_price: 4000, auto_source: "calc_internal_stair_steps", multiplier: 1, scope: 'global' },
      { name: "İç Merdiven Korkuluk", unit: "mt", unit_price: 2000, auto_source: "calc_internal_stair_railing_mt", multiplier: 1, scope: 'global' }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "Duşakabin", unit: "Adet", unit_price: 10350, auto_source: "calc_shower_cabin", multiplier: 1, scope: 'unit' },
      { name: "Duş Seti (Başlık/Hortum)", unit: "Set", unit_price: 2588, auto_source: "calc_shower_set", multiplier: 1, scope: 'unit' },
      { name: "Lavabo Bataryası", unit: "Adet", unit_price: 1605, auto_source: "calc_basin_mixer", multiplier: 1, scope: 'unit' },
      { name: "Evye Bataryası", unit: "Adet", unit_price: 3625, auto_source: "calc_sink_mixer", multiplier: 1, scope: 'unit' }
    ]
  },
  {
    id: "mekanik_tesisat",
    ...
    items: [
      { name: "Sıhhi Tesisat (Temiz+Pis Su)", unit: "Daire", unit_price: 35000, auto_source: "calc_plumbing_unit", multiplier: 1, scope: 'unit' },
      { name: "Kombi ve Baca Montajı", unit: "Adet", unit_price: 32000, auto_source: "calc_combi_count", multiplier: 1, scope: 'unit' },
      { name: "Kalorifer Altyapısı (Mobil Sistem)", unit: "m2", unit_price: 450, auto_source: "calc_radiator_infrastructure", multiplier: 1, scope: 'unit' },
      { name: "Panel Radyatör (DemirDöküm vb.)", unit: "mt", unit_price: 3800, auto_source: "calc_radiator_len", multiplier: 1, scope: 'unit' },
      { name: "Radyatör Montaj ve Vanalar", unit: "Adet", unit_price: 650, auto_source: "calc_radiator_count", multiplier: 1, scope: 'unit' },
      ...
      { name: "Doğalgaz Bina Ana Altyapısı", unit: "Paket", unit_price: 1, auto_source: "calc_gas_infrastructure", multiplier: 1, scope: 'global', inputType: 'manual_total' },
      { name: "Doğalgaz Proje ve Onay Bedeli", unit: "Paket", unit_price: 1, auto_source: "calc_gas_subscription", multiplier: 1, scope: 'global', inputType: 'manual_total' },
      ...
      { name: "Modüler Su Deposu (2m3 Paket)", unit: "Paket", unit_price: 15000, auto_source: "calc_water_tank", multiplier: 1, scope: 'global', inputType: 'manual_total' },
      { name: "Hidrofor Sistemi", unit: "Paket", unit_price: 12000, auto_source: "calc_hydrophore", multiplier: 1, scope: 'global', inputType: 'manual_total' },
  ...
  },
  {
    ...
    items: [
      { name: "Temel Topraklaması (Galvaniz Şerit)", unit: "mt", unit_price: 250, auto_source: "calc_foundation_grounding", multiplier: 1, scope: 'global' },
      ...
      { name: "Daire Sigorta Panosu ve Şalt Malz.", unit: "Adet", unit_price: 6500, auto_source: "calc_sub_panel_count", multiplier: 1, scope: 'unit' },
      { name: "Merkezi Uydu Sistemi", unit: "Paket", unit_price: 12000, auto_source: "calc_satellite_system", multiplier: 1, scope: 'global', inputType: 'manual_total' },
      ...
      { name: "Akıllı Ev Altyapı ve Donanım Paketi", unit: "Paket", unit_price: 1, auto_source: 'calc_smart_home', multiplier: 1, scope: 'global', inputType: 'manual_total' }
    ]
  },
  {
    id: "peyzaj_cevre",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Gazbeton Blok (m3)", unit: "m3", unit_price: 2650, auto_source: "manual", multiplier: 0, scope: 'hidden' },
      { name: "Tuğla Blok (m3)", unit: "m3", unit_price: 2100, auto_source: "manual", multiplier: 0, scope: 'hidden' },
